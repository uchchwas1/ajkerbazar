...
//$id=$_GET["id"];
//$res3=mysqli_query($link,"select * from users where r_id='". $_SESSION['resid']."'");
$res3=mysqli_query($link,"select * from users where id=$id");
               ...
               <div class="box round first">
                 ...
                 <div>
                  ...
                  <tr>
         					<th>Set Status</th>
         					<td>
                    <select name="ss" value="<?php echo $odr_st; ?>">
                  ...
                  //mysqli_query($link,"UPDATE users SET status='$_POST[ss]' WHERE username='$usr_nm'");
                  mysqli_query($link,"UPDATE users SET status='$_POST[ss]' WHERE id=$id");
