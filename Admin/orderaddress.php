         ...
         <!-- <div class="col-md-8">
           ...
           <div class="grid_10">
               <div class="box round first">
                 ...
                 <div class="block">
                   <?php
                   $res=mysqli_query($link,"select * from address order by id desc");
                   echo "<table border='1'>";
                   echo "<tr>";
                   ...
                   echo "<th>"; echo "show order"; echo "</th>";
                   echo "</tr>";
                   while ($row=mysqli_fetch_array($res))
                   {
                     ...
                     echo "<td>"; ?><a href="orderdetails.php?id=<?php echo $row["id"]; ?>">see order</a> <?php echo "</td>";
                     echo "</tr>";
                   }
                   echo "</table>";
                    ?>
